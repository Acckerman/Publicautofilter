<p align="center">
  <img src="https://graph.org/file/2364f09549c5f4e72fac1.jpg" alt="Acckerman Logo">
</p>
<h1 align="center">
...
Read [this](https://telegram.dog/Contact_R2) before you start messing up with your edits.
...
* `MODE`: True or False . If true then bot will rename files else it will not rename.
* `RENAMERS`: ID of the users to which you want to give file renaming authentication. Separate multiple ids by space.
...
<a target="_blank" href="https://app.koyeb.com/deploy?type=git&repository=github.com/LazyDeveloperr/Acckerman &branch=master&name=lazyprincessbot"><img alt="Deploy to Koyeb" src="https://binbashbanana.github.io/deploy-buttons/buttons/remade/koyeb.svg"></a>


<details><summary>Deploy To Heroku</summary>
<p>
<br>
<a href="https://heroku.com/deploy?template=https://github.com/Acckerman/publicautofilter">
